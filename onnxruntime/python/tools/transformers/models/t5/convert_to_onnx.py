...
import torch
from t5_helper import PRETRAINED_MT5_MODELS, PRETRAINED_T5_MODELS, CUSTOM_MODELS, T5Helper
...
def parse_arguments():
    ...
    pretrained_models = PRETRAINED_T5_MODELS + PRETRAINED_MT5_MODELS + CUSTOM_MODELS
    parser.add_argument(
        "-m",
        "--model_name_or_path",
        required=False,
